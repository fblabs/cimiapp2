...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CDatabase_t, stringdata) + ofs \
...
void CDatabase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CDatabase *_t = static_cast<CDatabase *>(_o);
        switch (_id) {
        case 0: { QString _r = _t->DbName();
...
const QMetaObject CDatabase::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CDatabase.data,
      qt_meta_data_CDatabase,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CDatabase.stringdata))
