...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_CSettings_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 33, 23)
    ...
    "CSettings\0on_pushButton_clicked\0\0"
...
const QMetaObject CSettings::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CSettings.data,
      qt_meta_data_CSettings,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CSettings.stringdata))
        return static_cast<void*>(const_cast< CSettings*>(this));
