...
# Template: app
# Command: C:/Qt/Qt5.3.1/5.3/mingw482_32/bin/qmake.exe -spec win32-g++ CONFIG+=debug -o Makefile CimiApp2.pro
#############################################################################
...
Makefile: CimiApp2.pro ../../../Qt/Qt5.3.1/5.3/mingw482_32/mkspecs/win32-g++/qmake.conf ../../../Qt/Qt5.3.1/5.3/mingw482_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec win32-g++ CONFIG+=debug -o Makefile CimiApp2.pro
